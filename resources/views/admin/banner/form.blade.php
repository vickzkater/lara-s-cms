...
@php
    $pagetitle = ucwords(lang('banner', $translation)); 
    if(isset($data)){
        $pagetitle .= ' ('.ucwords(lang('edit', $translation)).')';
        $link = route('admin.banner.do_edit', $data->id);
    }else {
        $pagetitle .= ' ('.ucwords(lang('new', $translation)).')';
        $link = route('admin.banner.do_create');
        $data = null;
    }
@endphp
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                            ...
                            @php
                                ...
                                echo set_input_form2('text', 'title', ucwords(lang('title', $translation)), $data, $errors, false, $config);
                                echo set_input_form2('text', 'description', ucwords(lang('description', $translation)), $data, $errors, false, $config);
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a href="{{ route('admin.banner.list') }}" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp; {{ ucwords(lang('cancel', $translation)) }}</a>
                                </div>
                            </div>
