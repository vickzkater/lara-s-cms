...
<div class="">
        ...
        @if (isset($data))
          <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                <a href="{{ route('admin_language_create') }}" class="btn btn-round btn-success" style="float: right;">Add New</a>
            </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><?php if(isset($deleted)) echo 'Deleted '; ?>Language List</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                          ...
                          @endphp
                            @foreach ($data as $item)
                              <tr>
                                ...
                                <td>
                                  <a href="{{ route('admin_language_edit', $item->id) }}" class="btn btn-xs btn-primary" title="Edit"><i class="fa fa-pencil"></i></a>
                                </td>
                              </tr>
                              @php
                                  $i++;
