...
if(isset($data)){
    $pagetitle .= ' (Edit)';
    $link = route('admin_division_do_edit', $data->id);
}else {
    $pagetitle .= ' (New)';
    $link = route('admin_division_do_create');
    $data = null;
}
@endphp
                ...
                <div class="x_content">
                    ...
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{ $link }}" method="POST" enctype="multipart/form-data">
                        ...
                        // set_input_form ($type, $input_name, $label_name, $data, $errors, $required = false, $placeholder = null, $id_name = null, $value = null, $attributes = null, $defined_data = null, $options = [])
                            echo set_input_form('text', 'name', 'Name', $data, $errors, true, 'Division Name', null, null, null);
                            echo set_input_form('textarea', 'description', 'Description', $data, $errors, false, 'Description ...', null, null, null);
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <a href="{{ route('admin_division_list') }}" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp; Cancel</a>
                            </div>
                        </div>
